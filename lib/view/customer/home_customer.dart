...
import 'package:service_laptop/view/customer/list_service_cutomer.dart';
...
class HomeCustomerV extends StatelessWidget {
  HomeCustomerV({Key key}) : super(key: key);
              ...
              child: ResponsiveGridRow(
                children: [
                  ResponsiveGridCol(
                    ...
                    child: InkWell(
                      onTap: () {
                        // serviceC.fetchServiceCustomerServiced();
                        Get.to(() => ServiceListCustomer(),
                  ...
                  ResponsiveGridCol(
                    ...
                    md: 3,
                    child: InkWell(
                      onTap: () => Get.to(() => HistoryServiceCustomer(),
                          duration: 0.5.seconds,
