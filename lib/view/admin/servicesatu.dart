...
import 'package:service_laptop/view/admin/servicedua.dart';
import 'package:sizer/sizer.dart';
import 'package:service_laptop/component/formfield.dart';

class StepSatu extends StatelessWidget {
  StepSatu({Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppbarStyle(
        title: Column(
          children: [
            Text("IDENTITAS BARANG", style: AppbarTitle()),
            Text(
              "1/3",
              style: EmailProfile(),
            )
                ...
                child: ElevatedButton(
                    ...
                    onPressed: () {
                      if (barangC.serialNumber.text != "" &&
                        ...
                        // print(barangC.serialNumber.text);
                        // print(barangC.seri.text);
                        // print(barangC.type.text);
                        // print(barangC.jenisBarang.value);
                      }
                    },
